      ...
      <main className="pt-20 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative h-[450px] w-full rounded-[3rem] overflow-hidden mb-12 shadow-2xl shadow-emerald-900/5 group">
            <Image src="/map-light.png" alt="Map Light" fill className="object-cover opacity-20 dark:hidden" />
            <Image src="/map-dark.png" alt="Map Dark" fill className="object-cover opacity-20 hidden dark:block" />
            ...
            <div className="absolute inset-x-0 bottom-0 p-12 z-20 flex flex-col items-center text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold text-primary mb-4 tracking-tight">{location.name}</h1>
              <div className="flex items-center gap-2 text-muted-foreground font-bold">
                <MapPin className="w-5 h-5 text-muted-foreground/60" /> {location.address}
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <p className="text-muted-foreground font-medium leading-[1.8] text-lg max-w-3xl">
                  Secure parking located in {location.address.split(',')[0]}. Ideal for visitors to surrounding business centers. Features wide parking bays suitable for all vehicles and security monitoring.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <AmenityItem icon={<Zap className="w-5 h-5 text-primary" />} label="EV Charging Available" />
                  <AmenityItem icon={<ShieldCheck className="w-5 h-5 text-primary" />} label="24/7 CCTV Surveillance" />
                  <AmenityItem icon={<UserRound className="w-5 h-5 text-primary" />} label="Disability Access" />
                  <AmenityItem icon={<Layers className="w-5 h-5 text-primary" />} label="Covered Parking" />
                </div>
              </div>
