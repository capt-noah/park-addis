        ...
        <div className="bg-card rounded-[2rem] border border-border shadow-sm overflow-hidden transition-colors">
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="pt-8 border-t border-border">
              <p className="text-[11px] font-extrabold text-red-500 uppercase tracking-widest mb-4">
                Danger Zone
              </p>
...
function ToggleRow({
  ...
  return (
    <div className="py-6 flex items-center justify-between group">
      ...
      <button
        className={`w-11 h-6 rounded-full relative transition-colors duration-300 ${enabled ? "bg-primary" : "bg-muted border border-border"}`}
      >
        <div
          className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${enabled ? "left-6 shadow-sm" : "left-1"}`}
        />
        {enabled && (
